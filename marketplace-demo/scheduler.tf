# Scheduling is now handled by GitHub Actions workflow (.github/workflows/marketplace-demo-reset.yml)
# which runs bi-weekly on Fridays at 7AM CET
#
# Previous AWS EventBridge Scheduler configuration (disabled):
#
